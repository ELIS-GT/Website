...
const Layout = ({
  ...
  return (
    <div className="beatrice-medium root-layout" theme-setting="style-2">
      ...
      <div id="smooth-wrapper">
        <div id="smooth-content">
          <div className="absolute w-[988.54px] h-[473.3px] top-0 end-[45%] -z-[1] opacity-80 blur-[250px] bg-gradient-120 from-[#F3FFAC] from-[11.58%] to-[#87D4FF] to-[82.42%]" />
